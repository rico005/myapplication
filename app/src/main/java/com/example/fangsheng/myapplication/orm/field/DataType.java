...
import com.example.fangsheng.myapplication.orm.field.types.BigDecimalNumericType;
import com.example.fangsheng.myapplication.orm.field.types.BigDecimalStringType;
import com.example.fangsheng.myapplication.orm.field.types.BigIntegerType;
import com.example.fangsheng.myapplication.orm.field.types.BooleanCharType;
import com.example.fangsheng.myapplication.orm.field.types.BooleanIntegerType;
import com.example.fangsheng.myapplication.orm.field.types.BooleanObjectType;
import com.example.fangsheng.myapplication.orm.field.types.BooleanType;
import com.example.fangsheng.myapplication.orm.field.types.ByteArrayType;
import com.example.fangsheng.myapplication.orm.field.types.ByteObjectType;
import com.example.fangsheng.myapplication.orm.field.types.ByteType;
import com.example.fangsheng.myapplication.orm.field.types.CharType;
import com.example.fangsheng.myapplication.orm.field.types.CharacterObjectType;
import com.example.fangsheng.myapplication.orm.field.types.DateLongType;
import com.example.fangsheng.myapplication.orm.field.types.DateStringType;
import com.example.fangsheng.myapplication.orm.field.types.DateTimeType;
import com.example.fangsheng.myapplication.orm.field.types.DateType;
import com.example.fangsheng.myapplication.orm.field.types.DoubleObjectType;
import com.example.fangsheng.myapplication.orm.field.types.DoubleType;
import com.example.fangsheng.myapplication.orm.field.types.EnumIntegerType;
import com.example.fangsheng.myapplication.orm.field.types.EnumStringType;
import com.example.fangsheng.myapplication.orm.field.types.EnumToStringType;
import com.example.fangsheng.myapplication.orm.field.types.FloatObjectType;
import com.example.fangsheng.myapplication.orm.field.types.FloatType;
import com.example.fangsheng.myapplication.orm.field.types.IntType;
import com.example.fangsheng.myapplication.orm.field.types.IntegerObjectType;
import com.example.fangsheng.myapplication.orm.field.types.LongObjectType;
import com.example.fangsheng.myapplication.orm.field.types.LongStringType;
import com.example.fangsheng.myapplication.orm.field.types.LongType;
import com.example.fangsheng.myapplication.orm.field.types.SerializableType;
import com.example.fangsheng.myapplication.orm.field.types.ShortObjectType;
import com.example.fangsheng.myapplication.orm.field.types.ShortType;
import com.example.fangsheng.myapplication.orm.field.types.SqlDateType;
import com.example.fangsheng.myapplication.orm.field.types.StringBytesType;
import com.example.fangsheng.myapplication.orm.field.types.StringType;
import com.example.fangsheng.myapplication.orm.field.types.TimeStampType;
import com.example.fangsheng.myapplication.orm.field.types.UuidType;
